...
/*
 * @GPIO_PIN_MODES
 * GPIO pin possible mods
 */
#define GPIO_MODE_IN 		0
#define GPIO_MODE_OUT 		1
#define GPIO_MODE_ALTFN		2
#define GPIO_MODE_ANALOG 	3
#define GPIO_MODE_IT_FT		4 //IT - input trigger, FT - falling edge Trigger
#define GPIO_MODE_IT_RT		5 //IT - input trigger, RT - rising edge Trigger
#define GPIO_MODE_IT_RFT	6 //IT - input trigger, Rising edge + falling edge Trigger
